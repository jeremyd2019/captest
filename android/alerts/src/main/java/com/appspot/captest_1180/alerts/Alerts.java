...
public class Alerts extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://captest-1180.appspot.com/_ah/api/";
  ...
  public class AlertsOperations {
    ...
    public class GetAlerts extends AlertsRequest<com.appspot.captest_1180.alerts.model.CAPAlertCollection> {
       ...
       */
      protected GetAlerts() {
        super(Alerts.this, "GET", REST_PATH, null, com.appspot.captest_1180.alerts.model.CAPAlertCollection.class);
      }
